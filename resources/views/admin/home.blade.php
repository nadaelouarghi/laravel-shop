      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="column grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-row justify-content-between">
                      <h4 class="card-title mb-1">Orders</h4>
                      <p class="text-muted mb-1">city/period</p>
                    </div>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                        Molestiae incidunt aliquid quod molestias pariatur et ratione dignissimos excepturi quam
                         accusantium unde itaque esse mollitia maxime quasi, nulla tenetur iste fugiat!<p>
                  </div>
                </div>
          </div>
           <
